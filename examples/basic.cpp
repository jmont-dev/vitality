...
int main() {
    ...
    // VITA metadata is big-endian on the wire and Vitality handles that for you.
    // Payload bytes are exposed exactly as received. If your payload word order on
    // the wire differs from your host representation, byteswap after copying.
    // Example:
